...
Nivel 3 - Comprensión de lectura literal e inferencial, y conocimiento gramatical y léxico en contexto: Demuestra la capacidad de entender información explícita, deducir significados implícitos y seleccionar palabras que sean adecuadas tanto gramatical como léxicamente dentro del contexto de un texto. Esto incluye la comprensión de la intención del autor y la interpretación de diferentes figuras retóricas.`,
        "default": `Enfócate en los conceptos clave y habilidades específicas requeridas para esta área de estudio en el examen SABER 11.`
    },
    actividades: {
        "glosarios extensos": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todos los términos clave relacionados con {valorSubtema} en {valorTemaPrincipal}.
● Asegúrese de incluir en los {tipoActividad} los términos clave que un alumno debe conocer para la prueba de {valorMateria} del examen SABER 11.
● Proporcione definiciones claras y concisas para cada término del subtema de {valorSubtema} teniendo en cuenta que el alumno tiene un nivel {nivelDificultad} de competencia y habilidad.
● Organice los términos en categorías lógicas dentro del tema de {valorTemaPrincipal}.`,
        "resúmenes detallados": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todos los conceptos principales que cubran los aspectos más relevantes del subtema de {valorSubtema} en {valorTemaPrincipal}.
● Asegúrese de incluir en los {tipoActividad} los conceptos clave que debe conocer para la prueba de {valorMateria} del examen SABER 11.
● Utilice frases cortas y precisas para explicar cada concepto de {valorSubtema}.
● Destaque las relaciones entre diferentes conceptos para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Incluya cualquier fórmula, fecha o dato específico de {valorSubtema} que sea crucial para el examen SABER 11.`,
        "tablas detalladas": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todos los conceptos principales que cubran los aspectos más relevantes del subtema de {valorSubtema} en {valorTemaPrincipal}.
● Asegúrese de incluir los conceptos clave que debe conocer para la prueba de {valorMateria} del examen SABER 11.
● Organice las {tipoActividad} con la información de {valorSubtema} en filas y columnas lógicas, usando encabezados claros.
● Destaque las relaciones entre diferentes conceptos para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Incluya cualquier fórmula, fecha o dato específico de {valorSubtema} que sea crucial para el examen SABER 11.`,
        "ejemplos prácticos resueltos": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Cree dos {tipoActividad} que reflejen situaciones realistas o problemas típicos relacionados con {valorSubtema} en el ámbito de {valorTemaPrincipal}.
● Proporcione una solución paso a paso para cada ejemplo o ejercicio, utilizando el lenguaje y metodología propios de la materia de {valorMateria}.
● Explique el razonamiento detrás de cada paso de la solución para un alumno de nivel {nivelDificultad} de competencia y habilidad.
● Conecte cada paso con los conceptos teóricos relevantes de {valorTemaPrincipal}.
● Incluya variaciones del problema para mostrar diferentes aplicaciones del mismo concepto relacionados con la materia de {valorMateria}.`,
        "analogías con comparaciones": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todos los conceptos clave de {valorSubtema} que puedan ser difíciles de entender en el contexto de {valorTemaPrincipal}.
● Cree tres {tipoActividad} que relacionen estos conceptos con situaciones o objetos de la vida cotidiana que ayuden a entender mejor {valorSubtema}.
● Explique detalladamente cómo cada parte de la analogía se relaciona con el concepto original de {valorTemaPrincipal}.
● Destaque las similitudes y también las limitaciones de cada analogía para un alumno con nivel {nivelDificultad} de competencia y habilidad.
● Proporcione ejemplos de cómo estas analogías pueden ayudar a resolver problemas típicos de la prueba de {valorMateria} en el examen SABER 11.`,
        "mapas conceptuales y diagramas mentales": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todos los conceptos principales y secundarios de {valorSubtema}.
● Cree {tipoActividad} que muestre claramente las relaciones entre estos conceptos, utilizando la terminología específica de {valorTemaPrincipal}.
● Use formas, colores o símbolos consistentes con la materia de {valorMateria} para representar diferentes tipos de información.
● Incluya etiquetas claras y concisas para cada elemento del mapa o diagrama.
● Proporcione una explicación detallada de cómo leer e interpretar el diagrama o mapa para un alumno con nivel {nivelDificultad} de competencia y habilidad.`,
        "aplicaciones y usos en la vida real": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique tres {tipoActividad} prácticos de {valorSubtema} en la vida cotidiana o en campos profesionales.
● Para cada aplicación, explique claramente cómo se relaciona con los conceptos estudiados en {valorTemaPrincipal}.
● Destaque cómo entender estas aplicaciones puede ayudar a resolver preguntas de un nivel {nivelDificultad} de competencia y habilidad en la prueba de {valorMateria} del examen SABER 11.
● Incluya ejemplos de cómo estas aplicaciones han llevado a innovaciones o avances en diferentes campos.
● Explique cómo estos ejemplos demuestran la relevancia de la materia de {valorMateria} en situaciones cotidianas.`,
        "juegos interactivos y actividades lúdicas": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Presente los {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Cree un concepto de {tipoActividad} que se centre en los aspectos clave de {valorSubtema}.
● Establezca reglas claras que fomenten el uso del conocimiento y las habilidades relevantes de {valorTemaPrincipal}.
● Incluya elementos de desafío con un nivel {nivelDificultad} de competencia y habilidad, que motiven al alumno a mejorar su comprensión.
● Asegúrese de que el juego cubra varios aspectos de subtema ${valorSubtema}, similar a cómo se abordaría en la prueba de ${valorMateria} de el examen SABER 11.
● Proporcione una explicación de cómo cada elemento del juego se relaciona con los objetivos de aprendizaje.`,
        "preguntas de opción múltiple con respuestas": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Cree tres {tipoActividad} que cubran diferentes aspectos de {valorSubtema} dentro del tema de {valorTemaPrincipal}.
● Asegúrese de que las preguntas reflejen el nivel {nivelDificultad} de competencia y habilidad del alumno y el formato de las preguntas específicas de {valorMateria} en el examen ICFES SABER 11.
...
● Piense paso a paso y de una explicación detallada y extensa de por qué la respuesta correcta es la adecuada y por qué las otras opciones son incorrectas.`,
        "preguntas de opción múltiple sin respuestas": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Cree cinco {tipoActividad} que cubran diferentes aspectos de {valorSubtema} dentro del tema de {valorTemaPrincipal}.
● Asegúrese de que las preguntas reflejen el nivel {nivelDificultad} de competencia y habilidad del alumno y el formato de las preguntas específicas de {valorMateria} en el examen ICFES SABER 11.
● Proporcione cuatro opciones de respuesta para cada pregunta que sean extensas en contenido y detalladas en información, requiriendo comprensión de lectura y análisis del tema, e incluyendo distractores plausibles.
● No indique cuál es la respuesta correcta.
● Asegúrese de que cada pregunta tenga una única respuesta correcta y que sea posible llegar a ella utilizando el conocimiento esperado de un alumno con un nivel {nivelDificultad} de competencia y habilidad en {valorMateria}.`,
        "valoraciones y rúbricas de autoevaluación": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todas las competencias evaluadas en {valorMateria}, relacionadas con {valorSubtema} y que sean relevantes para un nivel {nivelDificultad} de competencia y habilidad.
● Para cada competencia, cree {tipoActividad} para tres niveles de avance o progreso en {valorSubtema} (por ejemplo: en desarrollo, competente, finalizado).
● Asegúrese de que las {tipoActividad} sean específicos, observables y medibles para el nivel {nivelDificultad} de competencia y habilidad en {valorMateria}.
● Incluya una columna para que el alumno puedan anotar evidencias de su desempeño en cada criterio de autoevaluación.
● Proporcione instrucciones claras sobre cómo usar la rúbrica y cómo interpretar los resultados para la materia de {valorMateria}.`,
        "default": `● Desarrolle su tarea siguiendo un proceso de razonamiento paso a paso y pensamiento autocrítico, asegurando la precisión académica en {valorMateria}.
● Proporcione {tipoActividad} con un estilo expositivo, formal, detallado y extenso. Por ningún motivo elabore otro tipo de actividad.
● Cumpla rigurosamente con los lineamientos de evaluación del ICFES SABER 11 para un alumno con un nivel {nivelDificultad} de competencia y habilidad.
● Identifique todos los conceptos clave de {valorSubtema} que son relevantes para el examen SABER 11.
● Cree contenido que aborde estos conceptos de manera clara y concisa.
● Incluya ejemplos, explicaciones y ejercicios prácticos.
● Asegúrese de que el contenido esté alineado con las tres competencias evaluadas en el examen ICFES SABER 11 para {valorMateria}.
● Adapte el formato y el estilo del contenido para que sea atractivo y fácil de entender para un alumno en Grado 11° de Colombia con un nivel {nivelDificultad} de competencia.`
    },
    niveles: {
        "BÁSICO (Solo Nivel 1)": `Para este estudiante de nivel BÁSICO, enfócate solo en el primer nivel de competencia y habilidad (Nivel 1) evaluado por el ICFES SABER 11 para la prueba de {valorMateria}. Asegúrate de que el contenido sea accesible y fácil de entender, proporcionando explicaciones claras y sencillas por medio de {tipoActividad}. El objetivo es ayudar al estudiante a desarrollar la primer competencia y habilidad con una comprensión fundamental de los conceptos mínimos relacionados con {valorSubtema} en el tema de {valorTemaPrincipal}.`,
        "INTERMEDIO (Nivel 1 y Nivel 2)": `Para este estudiante de nivel INTERMEDIO, aborda solo los dos primeros niveles de competencias y habilidades (Niveles 1 y 2) evaluados por el ICFES SABER 11 para la prueba de {valorMateria}. El contenido debe introducir conceptos más complejos que el nivel básico, requiriendo un mayor nivel de análisis. Proporciona {tipoActividad} que muestren cómo se interrelacionan las dos primeras competencias y habilidades en el contexto de {valorSubtema} en el tema de ${valorTemaPrincipal}.`,
        "AVANZADO (Todos los 3 Niveles)": `Para este estudiante de nivel AVANZADO, integra los tres niveles de competencias y habilidades (Niveles 1, 2 y 3) evaluados por el ICFES SABER 11 para la prueba de ${valorMateria}. El contenido debe requerir de pensamiento crítico y análisis. Incluye {tipoActividad} que necesiten la aplicación simultánea de múltiples conceptos y de las tres competencias y habilidades, fomentando la capacidad del estudiante para hacer conexiones entre diferentes aspectos de ${valorSubtema} en el tema de ${valorTemaPrincipal} y su aplicación en situaciones del mundo real.`,
        "default": `Adapta el contenido al nivel de dificultad apropiado para un estudiante promedio de Grado 11° que se prepara para el examen SABER 11 en {valorMateria}.`
    }
};
